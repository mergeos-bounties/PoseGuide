...
1. Star https://github.com/mergeos-bounties/PoseGuide and https://github.com/mergeos-bounties/mergeos  
...
4. Open a PR to **PoseGuide** (public product repo) with \`Fixes #<this-issue>\`
